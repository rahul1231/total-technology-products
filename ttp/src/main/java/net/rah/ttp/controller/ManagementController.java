package net.rah.ttp.controller;
...
import net.rah.ttp.util.FileUploadUtility;
import net.rah.ttp.validator.ProductValidator;
import net.rah.ttpbackend.dao.CategoryDAO;
import net.rah.ttpbackend.dao.ProductDAO;
import net.rah.ttpbackend.dto.Category;
import net.rah.ttpbackend.dto.Product;
...
public class ManagementController {
	...
	public String handleProductActivation(@PathVariable int id) {
		// is going to fetch the product form the database
